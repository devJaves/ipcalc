...
function validate() {
	...
	if ( /(((25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|(2[0-4][0-9])|([1-9][0-9])|[1-9])\.((25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|(2[0-4][0-9])|([1-9][0-9])|[0-9])\.((25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|(2[0-4][0-9])|([1-9][0-9])|[0-9])\/(30|([1-2][0-9])|[8-9]))/.test(wan) && /(((25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|(2[0-4][0-9])|([1-9][0-9])|[1-9])\.((25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|(2[0-4][0-9])|([1-9][0-9])|[0-9])\.((25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|(2[0-4][0-9])|([1-9][0-9])|[0-9])\/(30|([1-2][0-9])|[8-9]))/.test(lan) ) {
		calculate();
	} else {
		alerty("Please enter valid IP addresses.");
	}
